 ...
 * Crawlerprogramme
 *
 * @ORM\Table(name="crawler_programme")
 * @ORM\Entity(repositoryClass="BackBundle\Repository\CrawlerprogrammeRepository")
 */
class Crawlerprogramme
{
    /**
     * @var int
     *
