...
class Medias
{
  ...
  /**
   ...
   /**
     ...
     * Add listedate
     *
     * @param \BackBundle\Entity\ListeDates $listedate
     *
     * @return Medias
     */
    public function addListedate(\BackBundle\Entity\ListeDates $listedate)
    {
        $this->listedates[] = $listedate;
     ...
     * @param \BackBundle\Entity\ListeDates $listedate
     */
    public function removeListedate(\BackBundle\Entity\ListeDates $listedate)
    {
        $this->listedates->removeElement($listedate);
    }
